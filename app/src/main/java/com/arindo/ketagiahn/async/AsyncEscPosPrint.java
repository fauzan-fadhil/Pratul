package com.arindo.ketagiahn.async;
...
import com.arindo.ketagiahn.TagihanBulananActivity;
import com.arindo.modulprint.EscPosCharsetEncoding;
    ...
    protected void onPostExecute(PrinterStatus result) {
        ...
        switch (result.getPrinterStatus()) {
            ...
            case AsyncEscPosPrint.FINISH_NO_PRINTER:
                new AlertDialog.Builder(context)
                        .setTitle("Printer tidak tersedia")
                        .setMessage("izinkan bluethooth untuk melanjutkan print")
                        .show();
