...
public class KunjunganActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                KunjunganActivity.this.finish();
            }
        });

        getSupportActionBar().setTitle("Daftar Kunjungan");
        ...
        adapter = new ListAdapterSql(KunjunganActivity.this, itemList);
    ...
    private void pemberitahuan() {
        ...
        alertDialogBuilder
                .setMessage("Data yang akan anda hapus adalah data kunjungan! lanjutkan. . .")
                .setCancelable(false)
    ...
    private void deletekunjungan() {
        androidx.appcompat.app.AlertDialog.Builder alertDialogBuilder = new androidx.appcompat.app.AlertDialog.Builder(
                this
        );
        alertDialogBuilder.setTitle("Reset Data ");
        alertDialogBuilder
                .setMessage("anda yakin akan menghapus data kunjungan")
                .setCancelable(false)
                .setPositiveButton("ya", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        SQLite.hapusdatakunjungan(getSpiner);
                        itemList.clear();
                        KunjunganActivity.this.finish();
                    }
                });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
       ...
       // searchIem.setEnabled(false);
       final SearchView searchView; searchView = (SearchView) searchIem.getActionView();
    ...
    private void getAllData() {
        ArrayList<HashMap<String, String>> row = SQLite.getAllData(getSpiner);
