...
import com.arindo.ketagiahn.adapter.ListViewAdapterPelunasan;
...
public class ActivityRepayment extends AppCompatActivity {

    ListView listView;
    List<ItemSQL> itemList = new ArrayList<ItemSQL>();
     ListViewAdapterPelunasan adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ActivityRepayment.this.finish();
            }
        });
        getSupportActionBar().setTitle("Repayment");
        SQLite = new DBHelper(getApplicationContext());
        listView = (ListView) findViewById(R.id.listview);
        noNotesView = findViewById(R.id.empty_notes_view);
        tidakadadata = findViewById(R.id.tidakadadata);
        Item = preferences.getString("kokedpref", null);
        adapter = new ListViewAdapterPelunasan(ActivityRepayment.this, itemList);
    ...
    private void getdatapelunasan() {
        ArrayList<HashMap<String, String>> row = SQLite.getdatapelunasan(getSpiner);
    ...
    private void updatedata() {
        String url_json = "https://bilman.arindo.net/index.php?r=bilman/updatetgk";
        ArrayList<HashMap<String, String>> row = SQLite.getStatus01(getSpiner);
        for (int J = 0; J < row.size(); J++) {
            final int finalJ = J;
            final RequestQueue requestQueue = Volley.newRequestQueue(ActivityRepayment.this);
