...
public class TampilActivityPemutusan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampilan_pemutusan);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(TampilActivityPemutusan.this, TampilActivityPemutusan.class));
                TampilActivityPemutusan.this.finish();
            }
        });

        getSupportActionBar().setTitle("Tagihan pemutusan");
...
//
        ...
        btnsimpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (spinerketspr.getSelectedItem().equals("-")){
                    Toast.makeText(TampilActivityPemutusan.this, "isi keterangan terlebih dahulu", Toast.LENGTH_LONG).show();
                } else if (!checkketsatu.isChecked()) {
                    Toast.makeText(TampilActivityPemutusan.this, "informasi tagihan belum di ceklis", Toast.LENGTH_LONG).show();
                } else if (!checkketdua.isChecked()) {
                    Toast.makeText(TampilActivityPemutusan.this, "informasi pembayaran belum di ceklis", Toast.LENGTH_LONG).show();
                } else if (!checkkettiga.isChecked()){
                    Toast.makeText(TampilActivityPemutusan.this, "informasi konsekuensi belum di ceklis", Toast.LENGTH_LONG).show();
                }  else {
                    //updatedata();
                    proses();
                    //saveToGallery();
    ...
    private void updatedata() {
        ...
        final RequestQueue requestQueue = Volley.newRequestQueue(TampilActivityPemutusan.this);
    ...
    public void onBackPressed() {
        startActivity(new Intent(TampilActivityPemutusan.this, ActivityRepayment.class));
        TampilActivityPemutusan.this.finish();
    }
