...
import com.arindo.ketagiahn.TampilActivityPemutusan;
import com.arindo.ketagiahn.TampilanActivityPelunasan;

public class ListViewAdapterPemutusan extends ArrayAdapter<ItemSQL> implements Filterable {
    ...
    public ListViewAdapterPemutusan(Activity activity, List<ItemSQL> items) {
        super(activity, R.layout.list_row4, items);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getContext(), TampilActivityPemutusan.class);
