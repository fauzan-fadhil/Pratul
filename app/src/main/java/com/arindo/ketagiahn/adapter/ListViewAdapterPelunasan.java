...
public class ListViewAdapterPelunasan extends ArrayAdapter<ItemSQL> implements Filterable {
    ...
    public ListViewAdapterPelunasan(Activity activity, List<ItemSQL> items) {
        super(activity, R.layout.list_row3, items);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getContext(), TampilanActivityPelunasan.class);
