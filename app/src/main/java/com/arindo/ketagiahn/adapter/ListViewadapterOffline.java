...
import com.arindo.ketagiahn.TampilanActivityOffline;

public class ListViewadapterOffline extends ArrayAdapter<ItemSQL> implements Filterable {
    ...
    public ListViewadapterOffline(Activity activity, List<ItemSQL> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getContext(), TampilanActivityOffline.class);
