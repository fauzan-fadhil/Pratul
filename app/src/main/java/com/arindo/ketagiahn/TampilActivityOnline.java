...
import static com.arindo.ketagiahn.SimpanOnlineActivity.TAG_TANGGALSURVEY;
import static com.arindo.ketagiahn.KunjunganActivity.TAG_TARIF;

public class TampilActivityOnline extends AppCompatActivity {

    Locale localeID;
    NumberFormat formatRupiah;
    private String spinerketstr, keterangan1str, keterangan2str, keterangan3str, namastr, alamatstr;
    private String rencanabayatstr, edtNoTelefonstr, latitud, langitud, tagihanstr;
    private String bulanstr, idpelstr, tarifstr, dayastr, kokedstr, langkahstr, tglsurveystr;
    private Spinner spinerketspr;
    private CheckedTextView checkketsatu, checkketdua, checkkettiga;
    private TextView rencanabayar, txttitikkordinat, txttagihan, txtbulan, txtidpel;
    private TextView txttarif, txtdaya, txtkoked, txtlangkah, tanggalsurvey, txtnama, txtalamat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tampil_online);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(TampilActivityOnline.this, SimpanOnlineActivity.class));
                TampilActivityOnline.this.finish();
            }
        });
        ...
        Log.e("tanggalsurveyonline", tglsurveystr);
