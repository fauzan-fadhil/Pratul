...
import com.arindo.ketagiahn.adapter.ListViewadapterOffline;
...
public class SimpanOfflineActivity extends AppCompatActivity {

    ListView listView;
    List<ItemSQL> itemList = new ArrayList<ItemSQL>();
    ListViewadapterOffline adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simpan_offline);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SimpanOfflineActivity.this.finish();
            }
        });

        getSupportActionBar().setTitle("Penyimpanan Internal");
        SQLite = new DBHelper(getApplicationContext());

        listView = (ListView) findViewById(R.id.listview);
        noNotesView = findViewById(R.id.empty_notes_view);
        tidakadadata = findViewById(R.id.tidakadadata);
        btnsimpanserver = findViewById(R.id.btnsimpanserver);


        btnsimpanserver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ShowDialog();
            }
        ...
        adapter = new ListViewadapterOffline(SimpanOfflineActivity.this, itemList);
    ...
    private void getStatus01() {
        ...
        for (int i = 0; i < row.size(); i++) {
            ...
            tanggalsurvey = row.get(i).get(TAG_TANGGALSURVEY);
    ...
    private void updatedata() {
        ...
        for (int J = 0; J < row.size(); J++) {
            final int finalJ = J;
            final RequestQueue requestQueue = Volley.newRequestQueue(SimpanOfflineActivity.this);
    ...
    private void editonline() {
        ...
        for (int i = 0; i < row.size(); i++) {
            ...
            String notelepon = row.get(i).get(TAG_NOTELEPON);
            String status = row.get(i).get(TAG_STATUS);
            tanggalsurvey = "21-01-2022";
            Log.e("simp tgl srv", tanggalsurvey);
